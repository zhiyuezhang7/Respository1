...
public class A1Example {
	...
	public static void main(final String[] args) {
		...
		final int sum = calculateValueSum(values);
		final int min = findValueMin(values);
		final int max = findValueMax(values);
	...
	/*
	 * calculateValueSum Calculates the sum on an array of integers
	 *
	...
	static int calculateValueSum(final int[] vals) {
	...
	/*
	 * findValueMin Finds and returns the minimum value in an array of integers
	 * 
	 * Input: array of integers vals
	 * 
	 * Output: minimum value found within the array
	 * 
	 * Preconditions: Input array must not be null and must contain at least one
	 * value.
	 */

	static int findValueMin(final int[] vals) {
	...
	/*
	 * findValueMax Finds and returns the maximum value in an array of integers
	 * 
	 * Input: array of integers vals
	 * 
	...
	static int findValueMax(final int[] vals) {
